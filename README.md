Jeg innså ikke at vi skulle ha mappen src før jeg var langt nede i main, så jeg hoppet litt over det og endret heller på sys.path.insert for å få testene til å fungere.
